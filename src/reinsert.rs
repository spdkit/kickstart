...
impl<G, F, E> MyElitistReinserter<G, F, E>
where
    G: Genotype,
    F: Fitness,
    E: FitnessFunction<G, F>,
{
    /// Constructs a new instance of the `MyElitistReinserter`.
    ...
    /// Returns the `replace_ratio` of this `MyElitistReinserter`.
    pub fn replace_ratio(&self) -> f64 {
        self.replace_ratio
    }

    /// Set the `replace_ratio` of this `MyElitistReinserter` to the given
...
impl<G, F, E> GeneticOperator for MyElitistReinserter<G, F, E>
where
    G: Genotype,
    F: Fitness,
    E: FitnessFunction<G, F>,
...
impl<G, F, E> SingleObjective for MyElitistReinserter<G, F, E>
where
    G: Genotype,
    F: Fitness,
    E: FitnessFunction<G, F>,
...
impl<G, F, E> MultiObjective for MyElitistReinserter<G, F, E>
where
    G: Genotype,
    F: Fitness,
    E: FitnessFunction<G, F>,
...
impl<G, F, E> ReinsertionOp<G, F> for MyElitistReinserter<G, F, E>
where
    G: Genotype,
    F: Fitness,
    E: FitnessFunction<G, F>,
